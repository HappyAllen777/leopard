...
<header class="am-topbar admin-header" style="width:100%;position:absolute">
	<div class="am-topbar-brand">
		<strong>Allen</strong> <small>后台管理</small>
	</div>
	...
	<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
		...
		<ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
			...
			<li class="am-dropdown" data-am-dropdown=""><a class="am-dropdown-toggle" data-am-dropdown-toggle="" href="javascript:;">
			...
			<li><a href="javascript:;" id="admin-fullscreen">
