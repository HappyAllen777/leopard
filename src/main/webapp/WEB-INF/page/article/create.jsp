...
<body>
	<div class="EDIT-AREA def-shadow" style="width: 500px;height:100%;float:left;overflow-y:scroll">
		...
		<div style="width:96%;height:40px;margin:0 2%">
			<input type="text" fd="article" dt="text" name="title" tip="文章标题" placeHolder="请输入文章标题" data-type="title" class="component def-input-text" style="padding: 3px 10px" />
		</div>
		<div style="height:10px;"></div>
		<div id="editbox" class="article-box" style="width:500px;min-width:500px;min-height: 0px;"></div>
		<div class="TOOL-BAR">
			<a class="button45 ADD-TITLE" onclick="openDialog('title-add-dialog')"><span class="icon-plus"></span>&nbsp;段落标题</a> <a
				...
				onclick="save('${project}/article/add')"><span class="icon-save"></span>&nbsp;保存</a>
		</div>
	</div>
	...
	<div id="picture-add-dialog" style="display: none;">
		...
		<div class="dialog">
			...
			<div id="dialog_msg" class="dialog-body">
				...
				<div class="blank-line-10"></div>
				<div>
					<a href="javascript:;" class="file-upload-button"> <span class="icon-plus"></span>添加图片 <input id="img1" type="file" onchange="uploadFile('img1','${project}/attachment/uploadFile')" class="img-input"
...
<script type="text/javascript" src="${project}/static/oss/js/form/form-util.js"></script>
</html>
